      ...
      >
        <form onSubmit={handleSubmit(onSubmit)}>
            ...
            <div className="relative mb-2">
                ...
                className="text-black text-sm w-full pl-10 p r-3 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-sky-500"
            ...
            {errors.connectCode && <p className="text-red-500 text-sm">{errors.connectCode.message}</p>}
             ...
             type="submit"
             disabled={isFetching}
             className="w-full flex justify-center items-center bg-sky-500 text-white py-2 rounded-lg hover:bg-blue-600 trasition cursor-pointer mt-4">
