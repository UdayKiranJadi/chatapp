...
const registerSchema = z.object({
    ...
    password: z.string().min(6,{message:"Password must me at least 6 characters long"}),
    ...
    <form onSubmit={handleSubmit(onSubmit)}>
        <div>
            ...
            <div className="relative mb-2">
                ...
                <input 
                {...register('fullName')}
                className="text-sm w-full pl-10 pr-3 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:r"
